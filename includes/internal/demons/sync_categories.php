...
class Sync_Categories {
    ...
    public static function init(): void {
        add_action( 'created_term',   [ __CLASS__, 'on_category_create'], 10, 3 );
        add_action( 'edited_term',    [ __CLASS__, 'on_category_update'], 10, 3 );
        add_action( 'save_post',      [ __CLASS__, 'on_product_category_update'], 10, 3 );
    }
    ...
    public static function on_product_category_update( int $post_id, WP_Post $post, bool $update ): void {
        ...
        $old_categories = wp_get_post_terms( $post_id, 'product_cat', ['fields' => 'ids'] );
